...
class MLP(nn.Module):
    ...
    def __init__(self, input_size=784, hidden_size=512, num_classes=10, T=6, surrogate='triangular', gamma=1.0, alpha=None):
        ...
        self.T = T
        self.surrogate = self.act.surrogate
    ...
    def lif_step(self, x_t, mem):
        ...
        spike = self.act.spike_function(mem - self.act.thresh)
        mem = (1.0 - spike) * mem
        return spike, mem
